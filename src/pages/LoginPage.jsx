...
// Mock SVGs for social logos (unchanged)
const GoogleIcon = () => (
...
export default function LoginPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!isLogin) {
      ...
      if (formData.roles.length === 0) alert("Please select at least one role.");
    }
      ...
      <main className="auth-form-panel">
        <div className="form-container">
          ...
          <div className="social-login-buttons">
            <button className="social-btn google-btn"><GoogleIcon /> Continue with Google</button>
            <button className="social-btn github-btn"><GithubIcon /> Continue with GitHub</button>
          </div>
